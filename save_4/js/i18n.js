...
const I18N = {
  ...
  settings_themes_title:    { fr: '🎨 Thèmes', en: '🎨 Themes' },
  settings_themes_desc:     { fr: 'Sélectionnez un ou plusieurs thèmes. Seules les questions des thèmes choisis seront posées. (Tout décoché = tous les thèmes)', en: 'Select one or more themes. Only questions from the chosen themes will be drawn. (All unchecked = all themes active)' },
  ...
  settings_order_moutarde:  { fr: 'Moutarde commence', en: 'Mustard first' },
  settings_order_creme:     { fr: 'Crème commence', en: 'Cream first' },
  settings_teams_title:     { fr: '👥 Équipes', en: '👥 Teams' },
  settings_teams_desc:      { fr: "Choisissez le nombre d'équipes (2 à 6) qui participeront à la partie.", en: 'Choose the number of teams (2 to 6) that will play.' },
  settings_team_count_label: { fr: "Nombre d'équipes", en: 'Number of teams' },
  btn_translate_q:          { fr: '🌐 Traduire la question', en: '🌐 Translate question' },
